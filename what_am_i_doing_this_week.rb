...
@@config = {
  ...
  skip_rows: 10,
  google_client_id: "323748040919.apps.googleusercontent.com",
  google_client_secret: "Sx4XX-51EHlxWc3cK-WOtv6q",
  config_file: File.expand_path("~/.what_am_i_doing_this_week")
}
